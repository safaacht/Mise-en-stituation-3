...
const changeAll = document.querySelector(".challenge3");
changeAll.addEventListener("click", () => {
  const innerDivs = document.querySelectorAll("div");
  innerDivs.forEach((div) => (div.style.background = "red"));
});
...
// Create an array and display it as a table (challenge33)
const chal33 = document.querySelector(".challenge33");

const arr = [
  ["Safaa", "Chtaoui", 21, "Casablanca"],
  ["Maria", "Aimad", 21, "Safi"],
  ["Safaa", "Afensou", 21, "BM"]
 ];
...
chal33.innerHTML = tableHTML;
}

renderTable();

// On click, sort the array and redisplay (challenge34)
const chal34 = document.querySelector(".challenge34");
...
`
const select=chal34.querySelector("select");
...
// On button click, create a new DOM element and append it (challenge36)
const chal36= document.querySelector(".challenge36");
...
const btns=chal36.querySelector("#button");
btns.addEventListener("click",()=>{
  const paragraphe=document.createElement("p");
  paragraphe.textContent="YaaaaY!!"
  chal36.appendChild(paragraphe);
})


// On button click, remove the next element (next div) (challenge37)
const chal37= document.querySelector(".challenge37");
chal37.innerHTML=`
<button id="delete">Detele</button>
`
const butn=chal37.querySelector("#delete");

butn.addEventListener("click",()=>{
  document.querySelector(".challenge38").remove();
})


const chal38= document.querySelector(".challenge38");